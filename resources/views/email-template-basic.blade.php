						...
						<tr style="box-sizing: border-box; margin: 0;">
							<td style="box-sizing: border-box; vertical-align: top; margin: 0; padding: 20px;" valign="top">
								...
								<table width="100%" cellpadding="0" cellspacing="0" style="box-sizing: border-box; margin: 0;">
									...
									<tr style="box-sizing: border-box; margin: 0;">
										<td style="box-sizing: border-box; color: #5867dd; font-size: 24px; font-weight: 700; text-align: center; vertical-align: top; margin: 0; padding: 0 0 10px;" valign="top">به نکستیبل خوش آمدید</td>
									</tr>
									<tr style="box-sizing: border-box; margin: 0;">
									...
									<tr style="box-sizing: border-box; margin: 0;">
										<td itemprop="handler" itemscope itemtype="http://schema.org/HttpActionHandler" style="box-sizing: border-box; vertical-align: top; margin: 0; padding: 10px 10px;" valign="top"><a href="#" itemprop="url" style="box-sizing: border-box; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: block; border-radius: 5px; text-transform: capitalize; background-color: #5867dd; margin: 0; border-color: #5867dd; border-style: solid; border-width: 10px 20px;">تایید آدرس ایمیل</a></td>
									</tr>
									<tr style="box-sizing: border-box; margin: 0;">
										<td style="box-sizing: border-box; padding-top: 5px; vertical-align: top; margin: 0; text-align: right;" valign="top">— قالب مدیریتی <b>Nextable</b></td>
									</tr>
								</table>
							</td>
						</tr>
